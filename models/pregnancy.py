...
class PregnancyReg(Base, BaseModel):
    ...
    pregnancy_num: Mapped[str] = mapped_column(String(20))
...
class PregRiskAssessment(Base, BaseModel):
    ...
    offered_hiv_councelling: Mapped[Choices]
    ...
    inadequate_financing: Mapped[Choices]
    ...
    history_of_infant_with_neurological_defects: Mapped[Choices]
...
class PregLabor(Base, BaseModel):
    ...
    time_membrane_ruptured: Mapped[str] = mapped_column(String(30))
    ...
    fetal_presentation: Mapped[str] = mapped_column(String(255)) 
...
class PregPartograph(Base, BaseModel):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
    pregnancy_num: Mapped[str] = mapped_column(ForeignKey('preg_reg.pregnancy_num'))
    hours_since_ruptured_membrane: Mapped[int] = mapped_column(Integer)
